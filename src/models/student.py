...
class Student:
    ...
    @property
    def average_mark(self): return self._average_mark

    @property
    def overall_grade(self): return self._overall_grade
    
    @password.setter
    def password(self, new_password: str): self._password = new_password
